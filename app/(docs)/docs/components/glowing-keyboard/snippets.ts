export const GLOWING_KEYBOARD_DEPENDENCIES = `npm i clsx tailwind-merge lucide-react motion`;
export const GLOWING_KEYBOARD_UTIL_FILE = `import { type ClassValue, clsx } from "clsx";
...
export const GLOWING_KEYBOARD_BASIC_FILE = `"use client";
...
export const GLOWING_KEYBOARD_CSS_FILE = `.glowing-key {
...
export const GLOWING_KEYBOARD_SVG_FILE = `
"use client";
