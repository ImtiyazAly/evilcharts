...
import { Button } from "../ui/border-button";
    ...
    <div className="relative flex h-[350px] w-full max-w-[500px] flex-col items-center">
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        <div className="relative z-10 flex h-[150px] w-[350px] items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
          {/* Badges */}
          <Button
            className="absolute bottom-8 left-12 z-10 h-7 rounded-full bg-[#101112] px-3 text-xs"
            buttonStyle="borded"
          >
            <HeartHandshakeIcon />
            <span>LegionDev</span>
          ...
          <Button
            className="absolute right-16 z-10 hidden h-7 rounded-full bg-[#101112] px-3 text-xs sm:flex"
            buttonStyle="borded"
          >
            <Folder />
